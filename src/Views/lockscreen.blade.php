...
<body>
    ...
    <div class="card">
        <img src="{{ asset('images/OptiGuard.png') }}" alt="OptiGuard Logo" class="optiguard-logo" onerror="this.onerror=null; this.src='https://cdn.appdutamall.com/bucket-cctv/cctv-thumbnails/logo_optigate.webp';" />
